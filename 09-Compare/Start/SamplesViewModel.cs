...
namespace LINQSamples
{
  public class SamplesViewModel : ViewModelBase
  {
    ...
    public List<Product> ExceptUsingComparerQuery()
    {
      ...
      // Write Query Syntax Here
      list = (from prod1 in list1 select prod1).
    ...
    public List<Product> ExceptByQuery()
    {
      ...
      List<string> colors = new() { "Red", "Black" };
            ...
            // Write Query Syntax Here
     list = (from prod1 in products select prod1)
    ...
    public List<Product> IntersectByMethod()
    {
      ...
      // Write Method Syntax Here
      list = products.IntersectBy(colors , prod => prod.Color).ToList();
    ...
    public List<Product> IntersectByProductSalesQuery()
    {
      ...
      // Write Query Syntax Here
      list = (from prod in products select prod).
                IntersectBy((from sale in sales select sale.ProductID) , prod => prod.ProductID).ToList();
    ...
    public List<Product> IntersectByProductSalesMethod()
    {
      ...
      // Write Method Syntax Here
      list = products.IntersectBy(sales.Select(sale => sale.ProductID), prod => prod.ProductID).ToList();
