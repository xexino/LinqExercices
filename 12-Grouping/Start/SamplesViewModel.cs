namespace LINQSamples
{
  public class SamplesViewModel : ViewModelBase
  {
      ...
      List<Product> products = ProductRepository.GetAll();
        ...
        public List<SaleProducts> GroupBySubQueryQuery()
        {
            ...
            list = (from sale in sales
                    ...
                    group sale by sale.ProductID into newSales
    ...
    public List<string> GroupByDistinctQuery()
    {
      ...
      list =  (from prod in products 
               orderby prod.Color
               group prod by prod.Color into groupedColor
               select groupedColor.FirstOrDefault().Color).ToList();
      return list;
    }
    #endregion
    ...
    public List<string> GroupByDistinctMethod()
    {
      ...
      // Write Method Syntax Here
      list = products.GroupBy(g => g.Color)
