  ...
  public class SamplesViewModel : ViewModelBase
  {
    ...
    public bool AnyQuery()
    {
      ...
      bool value = false;
            ...
            // Write Query Syntax Here
            value = (from sale in sales select sale).Any(sale => sale.UnitPrice > 80);
    ...
    public bool AnyMethod()
    {
      ...
      // Write Method Syntax Here
      value = sales.Any(sale => sale.LineTotal > 8800);
    ...
    public bool ContainsQuery()
    {
      ...
      // Write Query Syntax Here
      value =(from num in numbers select num).Contains(8);
