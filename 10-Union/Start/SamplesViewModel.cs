namespace LINQSamples
{
  public class SamplesViewModel : ViewModelBase
  {
    ...
    public List<int> UnionIntegersQuery()
    {
      ...
      list = (from num in list1 select num).Union(list2).OrderBy(num => num).ToList();
    ...
    public List<int> UnionIntegersMethod()
    {
      ...
      // Write Query Syntax Here
     list = list1.Select(num => num).Union(list2).OrderBy(num => num).ToList();
    ...
    public List<Product> UnionQuery()
    {
      ...
      // Write Query Syntax Here
     list = (from lista in list1 select lista).Union(list2 , pc).OrderBy(lis => lis.Name).ToList();
    ...
    public List<Product> UnionMethod()
    {
      ...
      list = list1.Union(list2 , pc).OrderBy(liss => liss.Name).ToList();
    ...
    public List<int> ConcatIntegersQuery()
    {
      ...
      List<int> list2 = new() { 1, 2, 3, 4, 5 };
            ...
            // Write Query Syntax Here
      list = (from prod in list1 select prod).Concat(list2).OrderBy(num => num).ToList();
    ...
    public List<Product> ConcatQuery()
    {
      ...
      // Write Query Syntax Here
      list = (from prod in  list1 select prod).Concat(list2).OrderBy(prod => prod.Name).ToList();
