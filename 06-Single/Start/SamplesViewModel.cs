  ...
  public class SamplesViewModel : ViewModelBase
  {
    ...
    public Product FirstOrDefaultQuery()
    {
      ...
      // Test the exception handling
       value = (from prod in products select prod)
                .FirstOrDefault(prod => prod.Color == "ioei" , new Product
                {
                    ProductID = -1 ,
                    Name = "Not Found" ,
    ...
    public Product FirstOrDefaultMethod()
    {
      ...
      Product value = null;
            ...
            value = products.FirstOrDefault(prod => prod.Color == "ioei", new Product
                     {
                         ProductID = -1,
                         Name = "Not Found",
    ...
    public Product LastQuery()
    {
      ...
      Product value = null;
            ...
            // Write Query Syntax Here
            value = (from prod in products select prod)
                .LastOrDefault(prod => prod.Color == "purple" , new Product
                {
                    ProductID = 0,
    ...
    public Product LastOrDefaultQuery()
    {
      ...
      // Write Query Syntax Here
      value = (from prod in products select prod).
                LastOrDefault(prod => prod.Name == "Red" , new Product
                {
                   ProductID= -1,
                   Name = "NOT FOUND"
                });
    ...
    public Product LastOrDefaultMethod()
    {
      ...
      Product value = null;
            ...
            // Write Method Syntax Here
            value = products.LastOrDefault(prod => prod.Name == "Red", new Product
            {
                ProductID = -1,
                Name = "NOT DOUND"
            });
    ...
    public Product SingleOrDefaultQuery()
    {
      ...
      Product value = null;
            ...
            // Write Query Syntax Here
            value = (from prod in products select prod).
                                 SingleOrDefault(prod => prod.ProductID == 706 , new Product
                                 {
                                     ProductID = -1 ,
                                     Name = "NO PRODUCT IN THE LIST"
                                 });
